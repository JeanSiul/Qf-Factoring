...
const S = {
  ...
  title: { margin: 0, fontFamily: 'Montserrat', fontSize: 22, fontWeight: 800, color: 'var(--qf-navy)' },
  ...
  kpiValue: { marginTop: 2, fontFamily: 'Montserrat', fontSize: 19, fontWeight: 850, lineHeight: 1.1 },
  card: { background: 'white', border: '1px solid var(--qf-border)', borderRadius: 14, overflow: 'hidden' },
  cardHeader: { display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'center', marginBottom: 12 },
  cardTitle: { margin: 0, color: 'var(--qf-navy)', fontFamily: 'Montserrat', fontSize: 16 },
  cardSub: { margin: '3px 0 0', color: 'var(--qf-text-light)', fontSize: 11 },
  filters: { display: 'flex', gap: 8, alignItems: 'center', marginBottom: 10, flexWrap: 'wrap' },
  select: { width: 150, height: 32, fontSize: 11, borderRadius: 6, border: '1px solid var(--qf-border)' },
  searchWrap: { position: 'relative', flex: 1, minWidth: 200 },
  searchIcon: { position: 'absolute', left: 10, top: '50%', transform: 'translateY(-50%)', fontSize: 12, opacity: 0.65 },
  searchInput: { width: '100%', height: 32, paddingLeft: 32, fontSize: 11, borderRadius: 6, border: '1px solid var(--qf-border)' },
  pagination: { display: 'flex', alignItems: 'center', gap: 6, marginBottom: 10, flexWrap: 'wrap' },
  resultPill: { border: '1px solid var(--qf-border)', background: '#f8fafc', borderRadius: 999, padding: '4px 8px', fontSize: 10, fontWeight: 700, color: 'var(--qf-navy)' },
  pageSize: { width: 65, height: 28, fontSize: 11, borderRadius: 6 },
  ...
  th: { position: 'sticky', top: 0, background: '#f0f7ff', zIndex: 1, color: 'var(--qf-navy)', fontSize: 9, fontWeight: 900, textTransform: 'uppercase', padding: '6px 8px', borderBottom: '1px solid #d4e0e9', cursor: 'pointer', textAlign: 'left', whiteSpace: 'nowrap' },
  tr: { height: 32 },
  td: { padding: '4px 6px', borderBottom: '1px solid #eef2f6', lineHeight: 1.15, verticalAlign: 'middle', fontSize: 10 },
  code: { background: '#e8eef5', borderRadius: 4, padding: '2px 4px', fontWeight: 800, fontSize: 9.5, color: 'var(--qf-navy)' },
  pill: { display: 'inline-block', background: '#e8eef5', borderRadius: 20, padding: '2px 6px', fontWeight: 600, fontSize: 9.5, whiteSpace: 'nowrap' },
  ...
  actionBtn: { fontSize: 8.5, padding: '1px 4px', borderRadius: 4 },
  dangerBtn: { fontSize: 8.5, padding: '1px 4px', color: '#c62828', borderRadius: 4 },
  footer: { marginTop: 8, color: 'var(--qf-text-light)', fontSize: 10 },
  empty: { textAlign: 'center', padding: 24, color: 'var(--qf-text-light)' },
  primaryBtn: { background: 'var(--qf-navy)', color: 'white', border: 'none', borderRadius: 8, padding: '6px 12px', fontWeight: 700, fontSize: 12 },
  secondaryBtn: { background: '#f8fafc', color: 'var(--qf-navy)', border: '1px solid var(--qf-border)', borderRadius: 8, padding: '6px 12px', fontWeight: 700, fontSize: 12 },
  clearBtn: { background: 'white', color: 'var(--qf-navy)', border: '1px solid var(--qf-border)', borderRadius: 8, padding: '6px 12px', fontWeight: 600 },
  ...
  modal: { background: 'white', borderRadius: 14, padding: 20, width: '100%', maxWidth: 860, maxHeight: '92vh', overflow: 'auto', boxShadow: '0 18px 50px rgba(0,0,0,0.25)' },
  modalHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  modalTitle: { margin: 0, fontFamily: 'Montserrat', color: 'var(--qf-navy)', fontSize: 18, fontWeight: 700 },
  detailGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 8 },
  detailBox: { background: '#f8fafc', border: '1px solid var(--qf-border)', borderRadius: 10, padding: 8 },
  ...
  input: { height: 34, fontSize: 12, borderRadius: 6, border: '1px solid var(--qf-border)', padding: '0 8px' },
